...
if __name__ == '__main__':
    ...
    c.execute(
        "INSERT INTO Entry (EntryId, UserId, NameOfBakingItem, NumExcellentVotes, NumOkVotes, NumBadVotes) VALUES (0, 1, 'Pie', 5, 0, 0)")  # UserId 1
    c.execute(
    ...
    c.execute(
        "INSERT INTO Entry (EntryId, UserId, NameOfBakingItem, NumExcellentVotes, NumOkVotes, NumBadVotes) VALUES (2, 3, 'Cake', 5, 0, 0)")  # UserId 3
    c.execute(
